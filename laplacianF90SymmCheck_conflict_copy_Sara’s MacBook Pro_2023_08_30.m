...
A = (M*L*inv(R));
spy(round((A-A')*100)/100); % SHOW SPARSITY OF THE SOLn



PsiTable = readtable('/Users/sarabek/Library/Mobile Documents/com~apple~CloudDocs/UofA/RAUAN/proj2/code/HALL_METHOD/Streamfunction.txt', 'ReadVariableNames', false);
Psi = table2array(PsiTable);
