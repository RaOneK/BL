clc; clear; close all;
figure('Renderer', 'painters', 'Position', [1240 700 600 400])
% params
m = 4; 
n = 4;
kx = 1.02;
...
for I = 1:m*n
    ...
    J1= (jj-1)*(m-1) + ii - 1;      %! index of u_i,j in the u vector
    Jr= (jj-1)*(m-1) + ii + 1 - 1;  %!index of u_i+1,j in the u vector
    ...
    fprintf("I = %3d; J1 = %3d; Jr = %3d; J2 = %3d; Ju = %3d; Jlw = %3d; Jlf = %3d;\n",I,J1,Jr,J2,Ju,Jlw,Jlf);
end
